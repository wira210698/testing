      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-inline my-2 my-lg-2" style="padding:10px;  margin-top:8px;" method="post" action="/grafik_kb">
             @method('get')
            ...
            <div class="col-md-12">
                <div class="panel panel-headline">
                        ...
                        <button class="btn btn-primary " type="buttom" style="float:right; margin-top:0; margin-right:15px; z-index:999;" data-toggle="modal" data-target=".modalCari"><i class="fa fa-search"></i></button>
							<h3 class="heading">Grafik Pelayanan Keluarga Berencana</h3>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="metric">
										...
										<p>
											<span class="number">{{$jmlhKB_baru_mkjp + $jmlhKB_baru_nonmkjp}}</span>
											<span class="title" style="padding:5px;">Jumlah Kunjungan Peserta KB Baru</span>
										</p>
									</div>
								</div>
								<div class="col-md-4">
									<div class="metric">
										...
										<p>
											<span class="number">{{$jmlhKB_lama_mkjp + $jmlhKB_lama_nonmkjp}}</span>
											<span class="title" style="padding:5px;">Jumlah Kunjungan Peserta KB Lama</span>
										</p>
									</div>
								</div>
							<div class="row">
...
<script>
    ...
    Highcharts.chart('charts_kunjungan_ibu', {
        ...
        title: {
            text: 'Grafik Kunjungan Peserta KB Baru'
        },
        subtitle: {
            text: 'Bulan: '+{!! json_encode($keterangan_grafik)!!}
        },
        xAxis: {
            categories: {!! json_encode($kategoriB)!!},
            crosshair: true
        },
        yAxis: {
            min: 0,
        ...
        series: [{
            name: 'NON MKJP',
            data:{!!json_encode($data_B_BL)!!},
            color:'skyblue'
        }, {
            name: 'MKJP',
            data: {!!json_encode($data_B_BI)!!},
            color:'orange'
    ...
    Highcharts.chart('charts_melahirkan', {
        ...
        title: {
            text: 'Grafik Kunjungan Peserta KB Lama'
        },
        subtitle: {
            text: 'Bulan: '+{!! json_encode($keterangan_grafik)!!}
        },
